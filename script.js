...
let paragraph2 = `Armed with a sack and a sinister grin, the Grinch slinked down the mountain and into the heart of Whoville under the cover of ${noun2}. He swiped everything in sight, from the festive decorations to the last can of ${holidayBeverage}. The Grinch thought he had succeeded in stealing the very essence of the holiday, imagining the disappointed faces of the Whos waking up to a Christmas-less morning.`

let paragraph3 = `But as the Grinch stood on the mountaintop, reveling in his triumph, he was met with an unexpected sight. The Whos of Whoville, undeterred by the absence of their belongings, joined hands and began to sing the song "${song}." The Grinch, perplexed by this display of resilience, felt a peculiar sensation in his heart. It started to grow, breaking the icy grip that had held it captive for so long. In that magical moment, the Grinch discovered the true meaning of ${winterHoliday} and, much to his surprise, found himself transformed into a kinder, more compassionate creature. And from that day forward, the Grinch became an honorary Who, celebrating the holidays with genuine warmth and newfound holiday spirit.`
